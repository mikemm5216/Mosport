...
export const oauthConfig = {
    google: {
        clientId: import.meta.env.VITE_GOOGLE_CLIENT_ID || '395326060348-r3av2c3qijuuq2ibdgfkd928ss9vbdbc.apps.googleusercontent.com',
        redirectUri: import.meta.env.VITE_OAUTH_REDIRECT_URI || 'https://mosport.app/auth/callback',
        authUrl: 'https://accounts.google.com/o/oauth2/v2/auth',
        scope: 'openid email profile',
    } as OAuthConfig,

    facebook: {
        clientId: import.meta.env.VITE_FACEBOOK_APP_ID || '1356000812963818',
        redirectUri: import.meta.env.VITE_OAUTH_REDIRECT_URI || 'https://mosport.app/auth/callback',
    ...
    zalo: {
        clientId: import.meta.env.VITE_ZALO_APP_ID || '4270389622263061825',
        redirectUri: import.meta.env.VITE_OAUTH_REDIRECT_URI || 'https://mosport.app/auth/callback',
