...
export const MOCK_EVENTS = [
    ...
    {
        id: 'e5',
        title: 'Yokohama F. Marinos vs Urawa Reds',
        league: 'J.League',
        sport: 'Football',
        startTime: new Date(new Date().setHours(18, 0, 0, 0)),
        teamA: 'Yokohama F. Marinos',
        teamB: 'Urawa Red Diamonds',
        isHot: true
    },
    {
        id: 'e5b',
        title: 'Kashima Antlers vs Kawasaki Frontale',
        league: 'J.League',
        sport: 'Football',
        startTime: new Date(new Date().setHours(19, 0, 0, 0)),
        teamA: 'Kashima Antlers',
        teamB: 'Kawasaki Frontale',
        isHot: true
    },
    {
        id: 'e5c',
        title: 'Vissel Kobe vs Cerezo Osaka',
        league: 'J.League',
        sport: 'Football',
        startTime: new Date(new Date().setHours(19, 30, 0, 0)),
        teamA: 'Vissel Kobe',
    ...
    },
    {
        ...
        sport: 'Baseball',
        startTime: new Date(new Date().setHours(18, 0, 0, 0)),
        teamA: 'Yomiuri Giants',
        teamB: 'Hanshin Tigers',
        isHot: true
    },
    {
        id: 'e6c',
        title: 'CTBC Brothers vs Uni-President Lions',
        league: 'CPBL',
        sport: 'Baseball',
        startTime: new Date(new Date().setHours(18, 30, 0, 0)),
        teamA: 'CTBC Brothers',
        teamB: 'Uni-President Lions',
        isHot: true
    },
    {
        id: 'e6d',
        title: 'Rakuten Eagles vs Softbank Hawks',
        league: 'NPB',
        sport: 'Baseball',
        startTime: new Date(new Date().setHours(18, 0, 0, 0)),
        teamA: 'Tohoku Rakuten Golden Eagles',
        teamB: 'Fukuoka SoftBank Hawks',
        isHot: false
    },
    {
        id: 'e6e',
        title: 'Fubon Guardians vs Rakuten Monkeys',
        league: 'CPBL',
        sport: 'Baseball',
        startTime: new Date(new Date().setHours(18, 35, 0, 0)),
        teamA: 'Fubon Guardians',
        teamB: 'Rakuten Monkeys',
        isHot: false
    },
    {
        id: 'e7',
    ...
    },
    {
        ...
        league: 'MLB',
        sport: 'Baseball',
        startTime: new Date(new Date().setHours(7, 10, 0, 0)),
    ...
    },
    {
        ...
        league: 'MLB',
        sport: 'Baseball',
        startTime: new Date(new Date().setHours(10, 10, 0, 0)),
...
export const JLEAGUE_TEAM_LINKS: Record<string, string> = {
    'Yokohama F. Marinos': 'https://www.f-marinos.com/',
    'Yokohama': 'https://www.f-marinos.com/',
    'F. Marinos': 'https://www.f-marinos.com/',
    'Urawa Red Diamonds': 'https://www.urawa-reds.co.jp/',
    'Urawa Reds': 'https://www.urawa-reds.co.jp/',
    'Urawa': 'https://www.urawa-reds.co.jp/',
    'Kashima Antlers': 'https://www.so-net.ne.jp/antlers/',
    'Kashima': 'https://www.so-net.ne.jp/antlers/',
    'Kawasaki Frontale': 'https://www.frontale.co.jp/',
    'Kawasaki': 'https://www.frontale.co.jp/',
    'Frontale': 'https://www.frontale.co.jp/',
    'Vissel Kobe': 'https://www.vissel-kobe.co.jp/',
    'Kobe': 'https://www.vissel-kobe.co.jp/',
    'Cerezo Osaka': 'https://www.cerezo.jp/',
    'Cerezo': 'https://www.cerezo.jp/',
    'C-Osaka': 'https://www.cerezo.jp/',
    'Gamba Osaka': 'https://www.gamba-osaka.net/',
    'Gamba': 'https://www.gamba-osaka.net/',
    'G-Osaka': 'https://www.gamba-osaka.net/',
    'FC Tokyo': 'https://www.fctokyo.co.jp/',
    'Tokyo': 'https://www.fctokyo.co.jp/',
    'Sanfrecce Hiroshima': 'https://www.sanfrecce.co.jp/',
    'Hiroshima': 'https://www.sanfrecce.co.jp/',
    'Nagoya Grampus': 'https://nagoya-grampus.jp/',
    'Nagoya': 'https://nagoya-grampus.jp/',
    'Grampus': 'https://nagoya-grampus.jp/',
    'Consadole Sapporo': 'https://www.consadole-sapporo.jp/',
    'Sapporo': 'https://www.consadole-sapporo.jp/',
    'Avispa Fukuoka': 'https://www.avispa.co.jp/',
    'Fukuoka': 'https://www.avispa.co.jp/',
};

export const NPB_TEAM_LINKS: Record<string, string> = {
    'Yomiuri Giants': 'https://www.giants.jp/',
    'Giants': 'https://www.giants.jp/',
    'Hanshin Tigers': 'https://hanshintigers.jp/',
    'Tigers': 'https://hanshintigers.jp/',
    'Chunichi Dragons': 'https://dragons.jp/',
    'Dragons': 'https://dragons.jp/',
    'Hiroshima Toyo Carp': 'https://www.carp.co.jp/',
    'Carp': 'https://www.carp.co.jp/',
    'Yakult Swallows': 'https://www.yakult-swallows.co.jp/',
    'Swallows': 'https://www.yakult-swallows.co.jp/',
    'Yokohama DeNA BayStars': 'https://www.baystars.co.jp/',
    'BayStars': 'https://www.baystars.co.jp/',
    'Fukuoka SoftBank Hawks': 'https://www.softbankhawks.co.jp/',
    'SoftBank Hawks': 'https://www.softbankhawks.co.jp/',
    'Softbank Hawks': 'https://www.softbankhawks.co.jp/',
    'Hawks': 'https://www.softbankhawks.co.jp/',
    'Tohoku Rakuten Golden Eagles': 'https://www.rakuteneagles.jp/',
    'Rakuten Eagles': 'https://www.rakuteneagles.jp/',
    'Eagles': 'https://www.rakuteneagles.jp/',
    'Saitama Seibu Lions': 'https://www.seibulions.jp/',
    'Seibu Lions': 'https://www.seibulions.jp/',
    'Lions': 'https://www.seibulions.jp/',
    'Chiba Lotte Marines': 'https://www.marines.co.jp/',
    'Lotte Marines': 'https://www.marines.co.jp/',
    'Marines': 'https://www.marines.co.jp/',
    'Orix Buffaloes': 'https://www.buffaloes.co.jp/',
    'Buffaloes': 'https://www.buffaloes.co.jp/',
    'Hokkaido Nippon-Ham Fighters': 'https://www.fighters.co.jp/',
    'Fighters': 'https://www.fighters.co.jp/',
};

export const CPBL_TEAM_LINKS: Record<string, string> = {
    'CTBC Brothers': 'https://www.brothers.tw/',
    'Brothers': 'https://www.brothers.tw/',
    '中信兄弟': 'https://www.brothers.tw/',
    'Uni-President Lions': 'https://www.uni-lions.com.tw/',
    'Lions': 'https://www.uni-lions.com.tw/',
    '統一獅': 'https://www.uni-lions.com.tw/',
    'Fubon Guardians': 'https://www.fubonguardians.com/',
    'Guardians': 'https://www.fubonguardians.com/',
    '富邦悍將': 'https://www.fubonguardians.com/',
    'Rakuten Monkeys': 'https://www.rakutenmonkeys.com.tw/',
    'Monkeys': 'https://www.rakutenmonkeys.com.tw/',
    '樂天桃猿': 'https://www.rakutenmonkeys.com.tw/',
    'TSG Hawks': 'https://www.tsg-hawks.com.tw/',
    'Hawks': 'https://www.tsg-hawks.com.tw/',
    '台鋼雄鷹': 'https://www.tsg-hawks.com.tw/',
    'Wei Chuan Dragons': 'https://www.weichuandragons.com.tw/',
    'Dragons': 'https://www.weichuandragons.com.tw/',
    '味全龍': 'https://www.weichuandragons.com.tw/',
};

export const NHL_TEAM_LINKS: Record<string, string> = {
    'Toronto Maple Leafs': 'https://www.nhl.com/mapleleafs',
    'Maple Leafs': 'https://www.nhl.com/mapleleafs',
    'Montreal Canadiens': 'https://www.nhl.com/canadiens',
    'Canadiens': 'https://www.nhl.com/canadiens',
    'Edmonton Oilers': 'https://www.nhl.com/oilers',
    'Oilers': 'https://www.nhl.com/oilers',
    'New York Rangers': 'https://www.nhl.com/rangers',
    'Rangers': 'https://www.nhl.com/rangers',
    'Boston Bruins': 'https://www.nhl.com/bruins',
    'Bruins': 'https://www.nhl.com/bruins',
    ...
    'Blackhawks': 'https://www.nhl.com/blackhawks',
    'Detroit Red Wings': 'https://www.nhl.com/redwings',
    'Red Wings': 'https://www.nhl.com/redwings',
};

export const MLB_TEAM_LINKS: Record<string, string> = {
